...
html_content2 = pd.read_html("https://www.graduateshotline.com/gre-word-list.html#x2")
html_content3 = pd.read_html("https://www.graduateshotline.com/gre-word-list.html#x3")
html_content4 = pd.read_html("https://www.graduateshotline.com/gre-word-list.html#x4")
html_content5 = pd.read_html("https://www.graduateshotline.com/gre-word-list.html#x5")
...
csv1.to_excel("random_gre_vocab.xlsx")
file = open("random_gre_vocab.xlsx", mode="r")
...
notification.notify(title=str(file[i][0]), message=str(file[i][1]), timeout=0)
